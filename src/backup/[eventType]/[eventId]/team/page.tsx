...
import { getUserTeam } from "@/backup/lib/actions/team.actions";
  ...
  if (user) {
    try {
      const { createAdminClient } =
        await import("@/backup/lib/appwrite/appwrite.server");
      const { appwriteConfig } =
        await import("@/backup/lib/appwrite/appwrite.config");

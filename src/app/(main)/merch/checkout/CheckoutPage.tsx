    ...
    <div className="min-h-screen w-full flex flex-col relative overflow-x-hidden">
      <div className="flex flex-col md:flex-row w-full grow min-h-screen">
        ...
        {/* =======================
            ...
            ======================= */}
        <div
          className="w-full md:w-1/2 lg:pt-36 bg-white flex flex-col justify-center"
          style={{
            inset: 0,
            background:
              "radial-gradient(175% 145% at 50% 10%, #070a10 30%, #d4a57475 60%, #d4a574 100%)",
          }}
        >
          <div className="max-w-md w-full mx-auto flex flex-col gap-5 bg-[#d4a57410]  shadow-xl p-5">
            ...
            <div className="space-y-3">
              {paymentMethods.map((method) => (
                <button
                  ...
                  className={`w-full p-4  border transition-all cursor-pointer duration-200 flex items-center justify-between group hover:border-[#d4a574] ${
                    ...
                    <div
                      className={`p-2 rounded-lg transition-colors ${
                        selectedMethod === method.id
                          ...
                          : " text-[#d4a57450] group-hover:bg-[#d4a574]/10 group-hover:text-[#d4a574]"
                      }`}
                    >
                      {method.icon}
                    </div>
            ...
            <div className="bg-[#070a1085]  p-4 space-y-2 text-white">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className=" font-medium line-through">₹35.00</span>
              </div>
            ...
            <button
              ...
              className={`flex items-center font-bold  justify-center gap-2 text-black border cursor-pointer hover:bg-[#d4a574] active:bg-[#d4a574] transition-all duration-200 hover:text-black border-black text-sm py-2 text-center bg-[#d4a57450] ${unispace.className}`}
            >
